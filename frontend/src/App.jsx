...
function App() {
  ...
  const getRecommendationIcon = (recommendation = "") => {
    ...
    if (value.includes("high-risk") || value.includes("priority")) {
    ...
    <div className="app">
      ...
      <aside className="sidebar">
        <div className="brand">
          ...
          <div>
            <div className="brand-name">Mastitis AI</div>
            <div className="brand-subtitle">Dairy Intelligence</div>
          </div>
        </div>
        ...
        <div className="sidebar-bottom">
          <div className="prototype-badge">
            ...
            <div>
              ...
              <span>Model outputs connected</span>
            </div>
          </div>
      ...
      <main className="main-content">
        ...
        <section className="section">
          <div className="section-heading">
            <div>
              <span className="section-kicker">CURRENT HERD STATUS</span>
              <h2>How is the herd right now?</h2>
            </div>
          ...
          <div className="hero-status-grid">
            ...
            <div className="metric-card">
              ...
              <div className="metric-label">TOTAL COWS</div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-label">AVERAGE CURRENT RISK</div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-label">HIGH-RISK COWS</div>
        ...
        <section className="section">
          <div className="section-heading">
            <div>
              <span className="section-kicker">MODEL 1</span>
              <h2>Current Herd Risk Distribution</h2>
            </div>
          ...
          <div className="distribution-card">
            ...
            <div className="distribution-footer">
              <div>
                ...
                {formatPercentage(herdData?.maximum_risk)}
              </div>
              ...
              <div>
                ...
                {formatPercentage(herdData?.median_risk)}
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="section-heading">
            <div>
              <span className="section-kicker">MODEL 2</span>
              <h2>Herd Risk Forecast</h2>
          ...
          <div className="forecast-grid">
            <ForecastCard
              title="7-Day Warning"
              value={formatPercentage(herdData?.warning_7d_percentage)}
              subtitle={`${herdData?.warning_7d_count ?? "--"} cows with elevated 7-day probability`}
              probability={herdData?.average_7d_probability}
            />

            <ForecastCard
              title="14-Day Warning"
              value={formatPercentage(herdData?.warning_14d_percentage)}
              subtitle={`${herdData?.warning_14d_count ?? "--"} cows with elevated 14-day probability`}
              probability={herdData?.average_14d_probability}
            />

            <ForecastCard
              title="Average 7-Day Probability"
              value={formatPercentage(herdData?.average_7d_probability)}
            ...
            <ForecastCard
              ...
              value={formatPercentage(herdData?.average_14d_probability)}
          ...
          <div className="forecast-explanation">
            ...
            <div>
              <strong>How to interpret this forecast</strong>
        ...
        <section className="section">
          <div className="section-heading">
            <div>
              <span className="section-kicker">PRIORITIZATION</span>
          ...
          <div className="table-toolbar">
            ...
            <div className="filter-group">
              {["ALL", "HIGH RISK", "MODERATE RISK", "LOW RISK"].map(
                (filter) => (
                  <button
                    key={filter}
                    className={
          ...
          <div className="table-card">
            {priorityCows.length === 0 ? (
              <div className="empty-state">
                ...
                <strong>No matching cows</strong>
                      ...
                      return (
                        <tr key={cow.cow_id}>
                          ...
                          <td>
                            ...
                            >
                              {getRiskIcon(cow.risk_category)}
                              {cow.risk_category || "Unknown"}
                            </span>
                          </td>
          ...
          <div className="high-risk-grid">
            {herdData?.high_risk_cows?.length > 0 ? (
              herdData.high_risk_cows.map((cow) => (
                <div className="high-risk-card" key={cow.cow_id}>
                  <div className="high-risk-card-header">
                    ...
                    <div>
                      <strong>{cow.cow_id}</strong>
                      <span>Current Model 1 prediction</span>
                    </div>
                  ...
                  <div className="high-risk-value">
                    {formatPercentage(cow.current_risk)}
                  </div>
              ...
              <div className="no-high-risk">
                ...
                <div>
                  <strong>No high-risk cows detected</strong>
                  <span>
        ...
        <section className="section">
          <div className="section-heading">
            <div>
              <span className="section-kicker">DATA PIPELINE</span>
        ...
        <section className="section">
          <div className="future-card">
            ...
            <div className="future-content">
              ...
              <h2>Designed to scale beyond the MVP</h2>
...
function RiskDistribution({
  ...
  const percentage =
    safeTotal > 0 ? (safeCount / safeTotal) * 100 : 0;

  return (
    <div className="distribution-item">
      <div className="distribution-item-header">
        <div className="distribution-label">
          <span className={`distribution-dot ${className}`}></span>
          {label}
        </div>
...
function InfrastructureCard({
  ...
  return (
    <div className="infrastructure-card">
      <div className="infrastructure-icon">{icon}</div>
